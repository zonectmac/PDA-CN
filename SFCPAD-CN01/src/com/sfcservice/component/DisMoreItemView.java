...
public class DisMoreItemView extends View {
	private int width;
	private int height;
	private ArrayList<DisMoreItemBean> listBean;

	public DisMoreItemView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		// TODO Auto-generated constructor stub
	}

	public DisMoreItemView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	}

	public DisMoreItemView(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		height = MyConfig.getMyConfig().getHeight() * 3 / 4;
