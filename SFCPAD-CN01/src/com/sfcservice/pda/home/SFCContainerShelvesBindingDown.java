...
public class SFCContainerShelvesBindingDown extends Activity implements
		...
		public void handleMessage(android.os.Message msg) {			
			switch (msg.what) {
				...
				case MyConfig.ACCESSF:
					...
					MyTool.toastShow(SFCContainerShelvesBindingDown.this, "连接服务器失败");
					break;
				case MyConfig.RESULTS:
					linePro.setVisibility(View.INVISIBLE);
					if (boxInfo) {
						String shelCode = MyConnection.getMyConnection()
								.getShelfNumByBox();
						
						etBindingShelfNum.setText(shelCode);
						etBindingShelfNum.setFocusable(false);
						etBindingShelfNum.setClickable(false);
						
						MyTool.toastShow(SFCContainerShelvesBindingDown.this,
								"恭喜,箱号检测可用");
						...
						MyTool.toastShow(SFCContainerShelvesBindingDown.this, "恭喜,成功绑定");
						String shelCode = MyConnection.getMyConnection()
								.getShelfNumByBox();
						nextStr = MyConnection.getMyConnection()
								.getShelfNumByBoxHaveNext();
						 
						if(nextStr.equalsIgnoreCase("Y")){
				...
				case MyConfig.RESULTF:
					...
					MyTool.toastShow(SFCContainerShelvesBindingDown.this, strMsg);
					etBindingShelfNum.setText("");
					etBoxNum.setText("");
					etBindingShelfNum.requestFocus();
					etBindingShelfNum.setFocusable(true);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.sfc_container_shelves_binding_down);
		init();
	}
	...
	public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
		...
		if (actionId == 0 || actionId == 6) {
			...
			if (MyConfig.getMyConfig().getNetGood()) {
				MyTool.hideInputKeyBroad(SFCContainerShelvesBindingDown.this);
				getBoxInfo();
				return true;
			}
		}
